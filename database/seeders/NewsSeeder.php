    ...
    public function run(): void
    {
        for ($i = 1; $i < 1000; $i++) {
            ...
            $news = array(
                "title" => $title,
                "slug" => Str::slug($title, "-"),
                "description" => "“Dù ai đi ngược về xuôi\r\nNhớ ngày giỗ tổ mùng 10 tháng 3”\r\nĐể kỷ niệm quốc lễ của dân tộc, Đồ đồng Điệp Oanh mang tới những sản phẩm đồ đồng chất lượng với nhiều ưu đãi hấp dẫn để khách hàng thoải mái chọn lựa và mua sắm các vật phẩm đón mừng đại lễ.",
                ...
                "type_id" => rand(0, 1),
                "pin" => rand(0, 1),
                "thumbnail" => "uploads/news/343555284_1298990017666140_2828860122205542360_n.jpg",
                "draft" => 0,
                "status" => 1,
                "view" => rand(10, 10000),
            );
